    ...
    <Footer>
      <div sx={{ minHeight: `300px`, width: `100%`, backgroundColor: `secondary`, padding: `5%`, position: `relative` }}>
        <div sx={{ display: `flex`, justifyContent: `space-around` }}>
          ...
          <div sx={{ fontFamily: "heading", fontSize: "2" }}>
          ...
          <div sx={{ position: `absolute`, left: `0`, right: `0`, bottom: `5%`, margin: `auto`, textAlign: `center` }}>
        ...
        <div sx={{ position: `absolute`, right: `5%`, bottom: `10%` }}>
          <Link destination="/">
            <Img
